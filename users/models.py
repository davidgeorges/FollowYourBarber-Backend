...
class User(models.Model):
    ...
    account_status = models.CharField(max_length=30, choices=[('ACTIVE', 'ACTIVE'), ('PENDING', 'PENDING'), ('SUSPENDED', 'SUSPENDED'), ('CARD_ID_PENDING', 'CARD_ID_PENDING')], default='PENDING', null=False, blank=False)
    phone_number_status = models.CharField(max_length=30, choices=[('PHONE_VERIFIED', 'PHONE_VERIFIED'), ('PHONE_PENDING', 'PHONE_PENDING')], default='PHONE_PENDING', null=False, blank=False)
    email_status = models.CharField(max_length=30, choices=[('EMAIL_VERIFIED', 'EMAIL_VERIFIED') ,('EMAIL_PENDING', 'EMAIL_PENDING')], default='EMAIL_PENDING', null=False, blank=False)
